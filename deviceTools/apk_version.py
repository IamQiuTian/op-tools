...
if __name__ == '__main__':
    ...
    arg.add_argument('-m','--mode',help='install or uninstall or reinstall or init or status or start or stop')
    arg.add_argument('-p','--package',help='select package')
    argd = arg.parse_args()
    if argd.mode is None or argd.package is None:
        print(arg.print_help())
        os._exit(1)
    elif argd.package not in package_list and argd.package != "all":
        print("input error!")
        os._exit(1)
